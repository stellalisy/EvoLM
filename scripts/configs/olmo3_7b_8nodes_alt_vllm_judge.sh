...
# Using OLMo-3-7B-Think as both policy and rubric generator (separate stacks)
# Mirrors qwen3_8b_8nodes_alt_vllm_judge.sh but with OLMo-3-7B-Think

HF_CHECKPOINT=${HF_CHECKPOINT:-allenai/Olmo-3-7B-Think}

if [ -z "$EXP_NAME_BASE" ]; then
    EXP_NAME_BASE="olmo3_7b_8nodes_alt_nup\${NUM_UNIQUE_PROMPTS_ROLLOUT}"
...
echo "[olmo3_7b_8nodes_alt_vllm_judge] Configuration:"
