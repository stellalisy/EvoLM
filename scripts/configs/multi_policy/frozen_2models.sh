#!/bin/bash
# Multi-policy frozen configuration: 2 policies
# Uses Qwen3-8B and Llama-3-8B as frozen policies

# Multi-policy frozen settings
MULTI_POLICY_MODELS="Qwen/Qwen3-8B,meta-llama/Meta-Llama-3-8B-Instruct"
