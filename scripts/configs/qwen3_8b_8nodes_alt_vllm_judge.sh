#!/bin/bash
# Configuration for alternating training with 8-node setup
...
# Rubric judge engines use the standard two-model default unless the launcher
# explicitly overrides the count.
...
echo "[qwen3_8b_8nodes_alt_vllm_judge] Configuration:"
...
#   ./scripts/launch.sh alternating_training dpo_model_ladder rubric_judge_server_vllm
#
# Or with tensor parallelism:
#   ./scripts/launch.sh alternating_training dpo_model_ladder rubric_judge_server_vllm DEEPSPEED_TENSOR_PARALLEL_SIZE=2
#
# This will create:
#   - Alternating training setup with doubled resources for two models
