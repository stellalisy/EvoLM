...
# Dataset settings
DATASET_MIXER_LIST=${DATASET_MIXER_LIST:-"allenai/llama-3.1-tulu-3-8b-preference-mixture 1.0"}
DATASET_MIXER_LIST_SPLITS=${DATASET_MIXER_LIST_SPLITS:-train}
DATASET_MIXER_EVAL_LIST=${DATASET_MIXER_EVAL_LIST:-"allenai/llama-3.1-tulu-3-8b-preference-mixture 1.0"}
