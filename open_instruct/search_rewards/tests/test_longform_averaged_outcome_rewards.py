...
spec = importlib.util.spec_from_file_location(
    "longform_averaged_outcome_rewards", os.path.join(search_rewards_dir, "longform_averaged_outcome_rewards.py")
)
...
REWARD_WEIGHTS = {"rubric": 0.5, "citation": 0.2, "format": 0.2, "num_search_turns": 0.1}
...
def compute_longform_averaged_outcome_reward(response: str, ground_truth: dict, question: str) -> dict:
    ...
    # Mock the extraction
    extracted_context, extracted_answer, extracted_citations = longform_module.extract_answer_context_citations(
        response
    )
            ...
            "Answer Critical": [
                {
                    ...
                    "Specifics": [{"Text": "The Great Wall was built over many dynasties", "Citation": "123456"}],
                }
            ],
            "Valuable": [],
            "Context": [],
