...
if __name__ == "__main__":
    ...
    score = score_in_context_citations(question, final_answer, citations)

    # Print the results for verification
    print("\n--- Debug Citation Reward Test ---")
    print(f"Question: {question}")

    print("\n--- Extracted by extract_answer_context_citations ---")
    print(f"Context:\n---\n{context}\n---")
    print(f"\nFinal Answer:\n---\n{final_answer}\n---")
    print(f"\nCitations Found:\n---\n{citations}\n---")
    print("----------------------------------------------------")

    print(f"\nCalculated citation score: {score}")
    print("--------------------------------\n")
