...
REWARD_WEIGHTS = {"rubric_reward": 0.7, "citation_reward": 0.1, "format_reward": 0.1, "num_search_turns_reward": 0.1}


def compute_longform_finegrained_reward_v2(
    response: str, ground_truth: dict[str, Any], question: str, mcp_parser_name: str | None = None
) -> dict[str, Any]:
    """
    ...
    num_search_turns_reward, num_search_turns = score_num_in_context_search_turns(
