...
def upload_scholarqabench_data(
    ...
    """
    with open("open_instruct/search_rewards/data/test_configs_snippets.json") as f:
        data = json.load(f)

    reference_answer_dict = {}
    with open("open_instruct/search_rewards/data/generated_reference_answers/reference_answers.jsonl") as f:
