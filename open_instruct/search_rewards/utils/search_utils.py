...
def score_num_in_context_search_turns(context: str, upper_bound: int = 3, mcp_parser_name: str | None = None) -> float:
    """
...
def score_query_redundancy(context: str, mcp_parser_name: str | None = None) -> float:
    """
...
def score_query_quality_in_a_row(context: str, mcp_parser_name: str | None = None) -> float:
    """
