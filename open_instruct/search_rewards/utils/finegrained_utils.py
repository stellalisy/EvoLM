...
def find_search_turns_reward_spans(
    response: str, num_search_turns_reward: float, return_span_only: bool = False
...
def find_rubric_reward_spans(
    response: str, rubric_reward: float, return_span_only: bool = False
) -> list["FinegrainedScore"]:
    """
...
def combine_all_reward_spans(
    ...
    citation_reward = FinegrainedScore(
        score=citation_reward, effective_spans=citation_spans, reward_group_id=5, reward_group_name="citation"
    )
