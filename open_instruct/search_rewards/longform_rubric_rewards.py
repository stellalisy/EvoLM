...
from open_instruct.search_rewards.utils.format_utils import compute_format_reward, extract_answer_context_citations
...
REWARD_WEIGHTS = {"rubric_reward": 0.5, "citation_reward": 0.2, "format_reward": 0.2, "num_search_turns_reward": 0.1}
REWARD_WEIGHTS_WITHOUT_CITATION = {"rubric_reward": 0.6, "format_reward": 0.2, "num_search_turns_reward": 0.2}
...
def compute_rubric_reward(
    response: str, ground_truth: dict[str, Any], use_general_rubric: bool = False
) -> dict[str, Any]:
    """
    ...
    result["reward"] = 0.8 * result["rubric_averaged_reward"] + 0.2 * in_context_search_turns_reward
    result["log_values"] = {
...
def compute_weighted_rubric_reward(response: str, ground_truth: dict[str, Any]) -> dict[str, Any]:
    ...
    result = {
        "reward": 0.0,
        "log_values": {"format_correct_has_answer": 0.0, "rubric_reward": 0.0, "num_rubrics": num_rubrics},
        "error": None,
    }
    ...
    rubric_scores_by_title, per_rubric_scores, overall_reward, persistent_reward, adaptive_reward = asyncio.run(
        _compute_rubric_scores_and_reward(extracted_answer, ground_truth)
    )
...
def compute_weighted_rubric_reward_with_citation_and_format_reward(
    response: str,
    ...
    if extracted_answer is None:
        ...
        result["log_values"]["per_rubric_rewards"] = {
            k: [v] for k, v in rubric_scores_by_title.items()
        }  # For rubric buffer management
    ...
    rubric_scores_by_title, per_rubric_scores, rubric_reward, persistent_reward, adaptive_reward = asyncio.run(
        _compute_rubric_scores_and_reward(
            extracted_answer, ground_truth, use_general_rubric=use_general_rubric, use_likert_rubric=use_likert_rubric
        )
    )
...
async def _compute_rubric_scores_and_reward(
    response: str, ground_truth: dict[str, Any], use_general_rubric: bool = False, use_likert_rubric: bool = False
...
Your JSON Evaluation:"""
        task = _score_property_async(
            response, question, None, system_prompt=system_prompt, user_prompt=user_prompt, score_scale=10.0
        )
        tasks.append(task)
...
if __name__ == "__main__":
    ...
    ground_truth = {
        ...
        "Answer Critical": [
            {
                ...
                "Specifics": [
                    {
                        "Text": "Sutter's studies ( 2012) also shows that design, quality and image are fundamental attributes in this market...Sutter et. al (2014) also analyze the issue of the Brazilian identity as a product differentiating element. The so-called 'Brasilidade', based on the valorization of the national culture according to the study, demonstrates that aspects that refer to attributes of Brazilian identity become a differential in the market, interfering in the perception of the buyers that identify in this aspect a facet that would make them pay more for the product...In order for this process to occur and the company to internationalize, some characteristics are identified by the study of (Sutter et al., 2016), they are: design, product quality, support and services, product attributes related to the country of origin and adequate price.",
                        "Citation": "115407351",
                    }
                ],
            },
            {
                "Ingredient": "Describe how Brazilian lifestyle, colors, national symbols, raw materials, craft techniques, shapes, and sensuality are leveraged by companies as aspects of Brazil\u2019s country image to enhance appeal in the fashion and beachwear sector abroad.",
                "Handle": "Brazilian Attributes Leveraged for Appeal",
                "Specifics": [
                    {
                        "Text": "Sutter, Polo and Maclennan, (2014) also sought to understand the effects of Brazilianness into fashion. For such, authors found the following elements as particular of Brazil's image into fashion: life style, colors, representations of Brazil and national symbols, natural raw materials, fabrics, applications and craft techniques, shapes and volumes.",
                        "Citation": "167755861",
                    },
                    {
                        "Text": "Guimar\u00e3es, Almeida, and Oliveira (2007), by analyzing the case of the jewelry brand H. Stern, exemplify how the company explores sensuality and beauty, which is another feature of the Brazilianness, in their product line.",
                        "Citation": "167755861",
                    },
                ],
            },
            {
                "Ingredient": "Mention how Country of Origin Image supports the internationalization process by enhancing product differentiation, motivating international expansion, and providing competitive advantage for Brazilian beachwear companies.",
                "Handle": "COI's Support for Internationalization",
                "Specifics": [
                    {
                        "Text": "In order for this process to occur and the company to internationalize, some characteristics are identified by the study of (Sutter et al., 2016), they are: design, product quality, support and services, product attributes related to the country of origin and adequate price.",
                        "Citation": "115407351",
                    },
                    {
                        "Text": "Segments like beachwear, lingerie and jeans-wear constitute the very strengths of the Brazilian apparel industry, worldwide recognised, and these product lines may drive the internationalization of the sector.",
                        "Citation": "56041853",
                    },
                ],
            },
        ...
        "Valuable": [
            {
                "Ingredient": "Discuss the influence of Brazil\u2019s country image as a brand and its exploitation in international promotion, including government and agency strategies (e.g., Apex, Brand Brazil).",
                "Handle": "COI as National Brand and Promotion",
                "Specifics": [
                    {
                        "Text": "Khauaja and Hemzo (2008) analyzed the construction of the Brand Brazil and and how it has been exploited by the Brazilian government agency Apex (Brazil's Export Promotion) in order to support the insertion of domestic products abroad.",
                        "Citation": "167755861",
                    }
                ],
            },
            {
                "Ingredient": "Describe how Brazilian beachwear products can serve diaspora and niche markets abroad, emphasizing potential for minimal adaptation due to their strong identification with Brazil.",
                "Handle": "Diaspora and Niche Markets for Beachwear",
                "Specifics": [
                    {
                        "Text": "This interpretation acknowledged two possibilities. On the one hand, it posited the existence of Brazilian niche markets abroad where products can be sold with the same characteristics as they are in the domestic market. One example mentioned was the case of Brazilian beachwear, a product strongly identified with the image of the country. Another considered the possibility of selling to Brazilians living abroad, or to segments where Brazilian products are in demand.",
                        "Citation": "2388271",
                    }
                ],
            },
            {
                "Ingredient": "Specify that internationalized Brazilian companies face challenges such as cultural differences and local adaptation but that maintaining a strong country image aids recognition and market entry.",
                "Handle": "Challenges and Recognition in Internationalization",
                "Specifics": [
                    {
                        "Text": "The main difficulties pointed out by internationalized Brazilian franchises are lack of knowledge of foreign markets, cultural differences, operational and legal difficulties and mainly the selection of suitable local franchisees...An investigation of the motivations for the internationalization of Brazilian franchises revealed the predominance of behavioral motivations, such as strengthening the company's image...",
                        "Citation": "233775078",
                    },
                    {
                        "Text": "The impact of institutional image is the photography, reputation and stereotype that stakeholders link to companies of a specific country that carry domestic heritage by the influence of national background, mainly institutional characteristics (Kostova & Zaheer, 1999).",
                        "Citation": "225598312",
                    },
                ],
            },
        ...
        "Context": [
            {
                "Ingredient": "Include background on the early stage of research on Brazil\u2019s country of origin image and call for more empirical investigations in this field.",
                "Handle": "Early Stage of COI Research",
                "Specifics": [
                    {
                        "Text": "However, studies about COI which have Brazil as the object of research are still at an early stage (Giraldi, Giraldi, & Scaduto, 2011) claiming for more empirical investigations.",
                        "Citation": "167755861",
                    },
                    {
                        "Text": "In addition, country image, according to Mariutti and Giraldi (2012), is an area of study that is gaining interest among researchers internationally.",
                        "Citation": "203484639",
                    },
                ],
            },
            {
                "Ingredient": "Describe how internationalization in the Brazilian beachwear sector requires strategic planning, investment, and is affected by the structural characteristics of Brazilian apparel firms.",
                "Handle": "Structural and Strategic Factors in Internationalization",
                "Specifics": [
                    {
                        "Text": "Segments like beachwear, lingerie and jeans-wear constitute the very strengths of the Brazilian apparel industry, worldwide recognised, and these product lines may drive the internationalization of the sector. However, internationalization is not an overnight change and requires time, investments and long run strategic planning, which hardly fits with the medium, small and micro enterprises constituting the very fabric of clothing industry in Brazil.",
                        "Citation": "56041853",
                    },
                    {
                        "Text": "In order for this process to occur and the company to internationalize, some characteristics are identified by the study of (Sutter et al., 2016), they are: design, product quality, support and services, product attributes related to the country of origin and adequate price.",
