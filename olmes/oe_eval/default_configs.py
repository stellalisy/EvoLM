...
TASK_DEFAULTS = {
    ...
    "livecodebench_shard_id": 0,  # Optional LiveCodeBench prompt shard index
    "livecodebench_num_shards": 1,  # Optional LiveCodeBench shard count
    "eval_shard_id": 0,  # Generic eval shard index (works for any task)
    "eval_num_shards": 1,  # Generic eval shard count
}
